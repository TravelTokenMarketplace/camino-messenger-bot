...
replace (
	github.com/chain4travel/camino-messenger-contracts/go/contracts => github.com/TravelTokenMarketplace/camino-messenger-contracts/go/contracts v0.0.0-20260609144505-9a8dc6f598b3
